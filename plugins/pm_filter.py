...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💠 ᴜᴘᴅᴀᴛᴇ 💠', url='https://t.me/+n191YY3q-k05ZDVl'),
            InlineKeyboardButton('💠 ɢʀᴏᴜᴘ  💠', url='https://t.me/cinemaathattakam_Group')
            ],[      
        ...
        buttons = [[
            InlineKeyboardButton('🤖 Updates', url='https://t.me/+n191YY3q-k05ZDVl'),
            InlineKeyboardButton('♥️ Source', url='https://t.me/cinemaathattakam_Group')
        ], [
            InlineKeyboardButton('🏠 Home', callback_data='start'),
